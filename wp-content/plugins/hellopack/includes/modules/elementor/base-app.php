...
{
    public const OPTION_NAME_PREFIX = 'elementor_connect_';

    public const SITE_URL = 'https://my.elementor.com/connect/v1';

    public const API_URL = HP_UPDATER_WP_JSON_URL . 'elementor-api?url=https://my.elementor.com/api/connect/v1';
    // public const API_URL =  'https://my.elementor.com/api/connect/v1';
    ...
    public function render_admin_widget()
    {
        ...
        if ($this->is_connected()) {
            ...
            $title = sprintf(__('Connected as %s', 'elementor'), '<strong>support@hellowp.io</strong>');
    ...
    protected function request($action, $request_body = [], $as_array = false)
    {
        ...
        if ($this->is_connected()) {
            ...
            $headers['X-access-token-secret'] = $this->get('access_token_secret');
    ...
    protected function get_remote_authorize_url()
    {
        ...
        $url = add_query_arg([
            ...
            'response_type' => 'code',
            'client_id' => $this->get('client_id'),
            'instance'  => get_option('hellopack_updater_instance'), //hellopack instance
